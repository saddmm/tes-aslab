...
<section class="content">
    <div class="box box-default collapsed-box">
        ...
        <div class="box-body">
            Tes ini ditujukan untuk penerimaan anggota baru Aslab Informatika
        </div><!-- /.box-body -->
    </div><!-- /.box -->
    <div class="box box-primary collapsed-box">
        ...
        <div class="box-body">
            <dl>
                <dd>
                    Dengan menggunakan Tes Tulis Aslab Informatika, maka anda setuju untuk :
                    <ol>
                        <li>Tidak mengubah Nama Aplikasi Ujian Online <b>Tes Tulis Aslab Informatika</b> menjadi nama aplikasi lain</li>
                        <li>Tidak mengubah footer yang menunjukkan alamat website Aplikasi Ujian Online Tes Tulis Aslab Informatika</li>
                        <li>Tidak menjual Aplikasi Ujian Online Tes Tulis Aslab Informatika. Tetapi anda diperbolehkan untuk mengambil keuntungan dari jasa proses instalasi, konsultasi dan lain sebagainya yang berkaitan dengan Aplikasi Ujian Online Tes Tulis Aslab Informatika</li>
                        <li>Tidak menhapus tribute dan Perjanjian Penggunaan</li>
                    </ol>
                    Semoga Aplikasi Ujian Online Tes Tulis Aslab Informatika dapat bermanfaat untuk kita semua.
                </dd>
            </dl>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif Tes Tulis Aslab Informatika, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online.</p>
    </div>
    <div class="box">
        <div class="box-header with-border">
